    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Kelola konten SEO dan artikel untuk Landing Page.</p>
        </div>
              ...
              {[1, 2, 3].map((i) => (
                <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="font-medium text-gray-900">Tips Lulus Ujian EPS-TOPIK Tahun 2024</div>
                    <div className="text-sm text-gray-500">/tips-lulus-eps-topik</div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">Okt 24, 2023</td>
